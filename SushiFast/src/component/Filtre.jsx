...
function Filtre({ Boxes, setBoxes, DATAboxes }) {
 ...
 <button className="bg-red-500 mr-4 rounded-full hover:bg-red-600 transition px-6 py-2 text-white" onClick={() => setBoxes(DATAboxes)}>Tous</button>
